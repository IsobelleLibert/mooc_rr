#+TITLE: Controling Software Environment
#+AUTHOR:  
...
- /What if a given software is not packaged ?/\vspace{-.3em}
  ...
  - Use additional alternative distribution (e.g., condas)
...
- Python ::  
  ...
  - =condas=: python and R distribution for scientific computing on
...
- GUIX/NiX :: Full-fledged /functional/ package manager 
  ...
  - Limited set of packages compared to Debian or Anacondas
...
4. Try doing the same with GUIX (for the braves $\winkey$)
