...
Pour démarrer, je vais télécharger le code source de Guix dans un nouveau répertoire:
#+begin_src sh :results output :exports both
cd $HOME
mkdir guix
cd guix
