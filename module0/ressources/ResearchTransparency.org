...
and is not a foolproof way of tackling fraud. What's more, *it is in no way a substitute for a thorough understanding of statistical methods
and concepts*.
...
will enable you to understand the general workings of a program. *This does not necessarily imply having a comprehensive understanding of the
configuration, but simply knowing enough to understand what is obtained as an output and to judge its credibility*. Data scientists and
