...
*** Quelles bonnes pratiques de modélisation (packages, fonctions, etc.) avez-vous appris à mettre en œuvre ? Comment assurez-vous le suivi des versions de vos scripts, de votre code, de vos textes, etc. ?
...
réécrit le programme plus proprement en utilisant des fonctions et des 
