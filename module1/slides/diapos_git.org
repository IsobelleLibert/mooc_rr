...
%    \node[DAGcommit, at (3,0)] (v0) {v0};
    ...
    \ga<.>{Chaque version du projet\\ (appelée \emph{commit} ou \emph{révision})\\ est identifiée par un SHA1\\\scalebox{.55}{\texttt{4fd4d17f73d4c024fb3ef69fb336cc10f2cd9b26}}}{right=of v3} %text width=3cm, 
...
- Ça versionne ! (« hist »)\medskip
- Ça facilite le travail collaboratif (« merge ») !\medskip
- Ça permet de stocker ses modifications localement (« commit ») !\medskip
#+LaTeX: \end{minipage}
- Ça permet de partager ses modifications quand on le souhaite (« pull/push ») !\medskip\pause
