...
1.  [Notes et références sur la séquence 3 : « Du fichier texte au langage de balisage léger »](#org736edbb)
    1.  [Fichier texte et éditeur de texte](#org0b71038)
    2.  [Le cas du fichier `PDF` ouvert avec un éditeur de texte](#orgeaa3b7b)
    3.  [Sur l'UTF-8](#orgac295bd)
