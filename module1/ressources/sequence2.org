...
We will now learn about an index construction technique due to [[https://en.wikipedia.org/wiki/John_Locke][John Locke]] (1632-1704)---the grand-father of liberalism and a major investor in the /Royal African Company/, the largest company in the [[https://en.wikipedia.org/wiki/John_Locke#Constitution_of_Carolina][slave-trade]] business at that time---; a detailed account of this method can be found in /Indexing commonplace books: John Locke’s method/ by Alan Walker, [[https://www.liverpooluniversitypress.co.uk/doi/epdf/10.3828/indexer.2001.22.3.2][The Indexer]], vol. 22, p. 114-118, 2001.
