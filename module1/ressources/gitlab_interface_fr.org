...
- Attention, la premère fois que vous vous connectez à votre espace Gitlab, vous avez le message suivant :
  #+BEGIN_CENTER
  [[file:gitlab_images/JupyterHubAuthorizeAccess.png]]
  #+END_CENTER
- Cliquez sur le bouton *Authorize*.
  #+BEGIN_CENTER
  [[file:gitlab_images/GitlabProject_fr.png]]
  #+END_CENTER
...
Pour récupérer le mot de passe prédéfini, il faut utiliser le [[https://app-learninglab.inria.fr/moocrr/jupyter/services/password][GitLab
