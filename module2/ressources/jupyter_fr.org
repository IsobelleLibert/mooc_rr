...
#+end_quote
qu'il faut absolument suivre pour que la suite se passe bien. La
première commande à lancer est
#+begin_src shell :results output :exports both
...
#+end_src
Il restent deux paquets que ne font pas partie de Miniconda. Nous
