...
- [[#installing-emacs][Installing Emacs]]
  ...
  - [[#macos][macOS]]
  - [[#windows][Windows]]
- [[#installing-emacs-python-r][Installing Emacs, Python and R]]
...
Install Miniconda following the supplied instructions. When the installer asks you the question
#+begin_quote
...
#+end_quote
which you must respect to make sure that the following steps work correctly. The first command to run next is
