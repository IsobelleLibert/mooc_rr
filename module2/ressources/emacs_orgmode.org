...
If you get tired of always re-executing all the source code when exporting, look for the following line in [[file:replicable_article/article.org][article.org]]:
#+BEGIN_EXAMPLE
# #+PROPERTY: header-args :eval never-export
#+END_EXAMPLE
