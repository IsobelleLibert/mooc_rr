...
- /Pour Windows :/ Ajouter le chemin de =Git= dans la variable =PATH= de Windows. La façon de procéder est très bien expliquée [[http://sametmax.com/ajouter-un-chemin-a-la-variable-denvironnement-path-sous-windows/][ici]].
